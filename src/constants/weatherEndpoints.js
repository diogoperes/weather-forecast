const WEATHER_URL = 'http://openweathermap.org/data/2.5';
...
export const SEARCH_LOCATION_URL = (location) => { return `${WEATHER_URL}/find?q=${location}&units=metric&appid=${APP_ID}`};